        ...
        <div style={styles.header}>
          <div>
            ...
            <p style={styles.subtitle}>
              View your orders, checkout status, and delivery progress.
            </p>
          </div>
        ...
        <section style={styles.card}>
          <div style={styles.sectionHeader}>
            <div>
              ...
              <p style={styles.sectionSubtitle}>Latest orders from your account.</p>
            </div>
  ...
  return (
    <div style={{ ...styles.statCard, borderColor: theme.border }}>
      <div>
        ...
        <h3 style={{ ...styles.statValue, color: theme.primaryDark }}>{value}</h3>
      </div>
